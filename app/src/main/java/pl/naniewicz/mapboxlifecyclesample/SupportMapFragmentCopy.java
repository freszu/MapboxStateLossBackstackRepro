...
/**
 * Changes in comparison to SupportMapFragment:
 * - MapViewWithState used instead of MapView
 * - Custom id is set to mapView to invoke state saving methods
 */
public class SupportMapFragmentCopy extends Fragment implements OnMapReadyCallback {

    private final List<OnMapReadyCallback> mapReadyCallbackList = new ArrayList<>();
    private MapFragment.OnMapViewReadyCallback mapViewReadyCallback;
    private MapboxMap mapboxMap;
    private MapViewWithState map;
     ...
     */
    public static SupportMapFragmentCopy newInstance() {
        return new SupportMapFragmentCopy();
    }
     ...
     */
    @NonNull
    public static SupportMapFragmentCopy newInstance(@Nullable MapboxMapOptions mapboxMapOptions) {
        SupportMapFragmentCopy mapFragment = new SupportMapFragmentCopy();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        map = new MapViewWithState(context);
        // without id set view state is never saved
        map.setId(R.id.idForMapToSaveState);
        return map;
    }
